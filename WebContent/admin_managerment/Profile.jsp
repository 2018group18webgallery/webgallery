...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="HomeAdmin.jsp" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							data-toggle="dropdown"> <!-- The user image in the navbar-->
								<img src="img/photo_large.png" class="user-image"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li ><a href="HomeAdmin.jsp"><i class="fa fa-home"></i>
							<span>Home</span></a></li>
					...
					<li class="treeview"><a href="#"><i
						...
						<ul class="treeview-menu">
							<li><a href="ListProduct.jsp" class="fa fa-circle-o">
									Danh sách sản phẩm</a></li>
							<li><a href="UpdateProduct.jsp" class="fa fa-circle-o">
									Thêm sản phẩm, Xóa Cập nhật</a></li>
						</ul></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					User Profile<small>Trang thông tin admin</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-primary">
							<div class="box-body box-profile">
								<img class="profile-user-img img-responsive img-circle"
									src="img/photo_large.png" alt="User profile picture">

								<h3 class="profile-username text-center">Bảo Lee</h3>

								<p class="text-muted text-center">Web - Developer</p>

								<ul class="list-group list-group-unbordered">
									<li class="list-group-item"><b>Full name</b> <a
										class="pull-right">Lê Chí Bảo</a></li>
									<li class="list-group-item"><b>Birthday</b> <a
										class="pull-right">Ngày 7 tháng 12</a></li>
									<li class="list-group-item"><b>Following</b> <a
										class="pull-right">11,999 - Lượt theo dõi</a></li>
								</ul>
