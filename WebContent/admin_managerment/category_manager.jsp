...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<%
				List<Category> lstCategory = CategoryDAO.getCategorys();
			%>
			...
			<table id="myTable1" class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><a
							href="<%=request.getContextPath()%>/update_category.jsp">Edit</a></td>
						<td><a
							href="<%=request.getContextPath()%>/CategoryManager*">Edit</a></td>
					</tr>
					<%
						}
					%>
