...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<%
				List<Service> lstService = ServiceDao.getListService();
			%>
				...
				<tbody>
					<%
						for (int i = 0; i < lstService.size(); i++) {
							Service ser = lstService.get(i);
					%>
					<tr>

						<td><%=ser.getServiceId()%></td>
						<td><%=ser.getServiceName()%></td>
						<td><%=ser.getPrice()%></td>

						<td><a
							href="<%=request.getContextPath()%>/update_service.jsp">Edit</a></td>
					</tr>
					<%
						}
					%>
